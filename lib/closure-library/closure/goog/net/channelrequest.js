 ...
 *     no throttle.
 */
goog.net.ChannelRequest.prototype.setReadyStateChangeThrottle = function (throttle) {
...
goog.net.ChannelRequest.prototype.onXmlHttpReadyStateChanged_ = function () {
    ...
    if (!goog.net.ChannelRequest.supportsXhrStreaming() ||
        (goog.userAgent.WEBKIT && !goog.userAgent.isVersionOrHigher(
        ...
        if (readyState < goog.net.XmlHttp.ReadyState.INTERACTIVE ||
            readyState == goog.net.XmlHttp.ReadyState.INTERACTIVE && !goog.userAgent.OPERA && !this.xmlHttp_.getResponseText()) {
            // not yet ready
            return;
        }
    }
